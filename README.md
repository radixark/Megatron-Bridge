...
- [GLM-5.3-Flash](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/src/megatron/bridge/models/glm5_next) — KDA + DSA hybrid MoE with mHC hyper-connections (LoRA-ready)
